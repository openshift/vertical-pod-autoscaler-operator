...
// Image parameters for an image pull spec
type Image struct {
	Format   string
	Registry string
	Operator string
...
// ImageURLGetter a function which returns an image pull spec
type ImageURLGetter func() (image *Image, err error)

// Loader The appropriate loader function for the test mode
