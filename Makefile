...
## e.g. make full-olm-deploy IMAGE_TAG_BASE=quay.io/$(USER)/vertical-pod-autoscaler-operator OPERATOR_VERSION=4.21.0 OPERAND_IMG=quay.io/${USER}/vertical-pod-autoscaler:latest
## This will create OPERATOR_IMG=$(IMAGE_TAG_BASE}:4.21.0, BUNDLE_IMG=${IMAGE_TAG_BASE}-bundle:4.21.0, and CATALOG_IMG=${IMAGE_TAG_BASE}-catalog:4.21.0
