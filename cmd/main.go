...
func printVersion() {
	setupLog.Info("Go Version", "version", goruntime.Version())
	setupLog.Info("Go OS/Arch", "os", goruntime.GOOS, "arch", goruntime.GOARCH)
	setupLog.Info("Version", "version", version.String)
}
...
func main() {
	...
	if secureMetrics {
		metricsServerOptions.CertDir = "/etc/metrics-tls-certs"
